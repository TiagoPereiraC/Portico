...
const detailTareasPorcentaje =
    document.getElementById("detailTareasPorcentaje");

const detailTareasProgreso =
    document.getElementById("detailTareasProgreso");

const detailTareasCompletadasTexto =
    document.getElementById("detailTareasCompletadasTexto");

const detailTareasTotalTexto =
    document.getElementById("detailTareasTotalTexto");
...
function renderDetalle(data) {
    ...
    if (detailTareasPorcentaje) {
        detailTareasPorcentaje.textContent =
            `${porcentajeCompletacion}%`;
    }

    if (detailTareasProgreso) {
        detailTareasProgreso.style.width =
            `${porcentajeCompletacion}%`;

        detailTareasProgreso.setAttribute(
            "aria-valuenow",
            porcentajeCompletacion
        );
    }

if (detailTareasCompletadasTexto) {
    detailTareasCompletadasTexto.textContent =
        totalCompletadas;
}

if (detailTareasTotalTexto) {
    detailTareasTotalTexto.textContent =
        totalTareas;
}
